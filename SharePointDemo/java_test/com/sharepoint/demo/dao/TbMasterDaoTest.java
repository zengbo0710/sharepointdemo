...
public class TbMasterDaoTest extends BaseDaoTestCase{
	
	private TbMasterDao dao;
	...
	public void findPage() {
		...
		TbMasterQuery query = newTbMasterQuery();
	...
	public static TbMasterQuery newTbMasterQuery() {
		TbMasterQuery query = new TbMasterQuery();
		query.setPageNumber(pageNumber);
		query.setPageSize(pageSize);
		query.setSortColumns(null);
		
	  	query.setCreatedBy(new String("1"));
	  	query.setModifiedBy(new String("1"));
	  	query.setVersion(new String("1"));
