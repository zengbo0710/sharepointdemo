...
<body scroll="no">
 <div class="content">
  ...
  <div id="header">
   ...
   <div id="personal">Current User ${sessionScope.userInfo.userName} | Role �${sessionScope.userInfo.role}<c:set value='${sessionScope.userInfo.role}' var='key'/><c:out value='${roleMap[key+0]}' />&nbsp; | <a href="login.jsp">Log out</a></div>
  </div>
