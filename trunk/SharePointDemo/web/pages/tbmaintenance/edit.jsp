...
<rapid:override name="head">
	<title><fmt:message key="TABLE_MAINTENANCE"/> <fmt:message key="Modify"/></title>
</rapid:override>

<rapid:override name="content">
	<form:form method="put" action="${ctx}/tbmaintenance/${tbMaintenance.id}" modelAttribute="tbMaintenance">
