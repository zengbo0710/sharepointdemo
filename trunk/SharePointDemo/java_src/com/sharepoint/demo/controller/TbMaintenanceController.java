...
public class TbMaintenanceController extends BaseRestSpringController<TbMaintenance,java.lang.Integer>{
	...
	public String create(ModelMap model,@Valid TbMaintenance tbMaintenance,BindingResult errors,HttpServletRequest request,HttpServletResponse response) throws Exception {
		if(errors.hasErrors()) {
			return  "/tbmaintenance/new";
		}
