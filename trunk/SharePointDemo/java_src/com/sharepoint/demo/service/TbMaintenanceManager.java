...
@Service
@Transactional
public class TbMaintenanceManager extends BaseManager<TbMaintenance,java.lang.Integer>{

	private TbMaintenanceDao tbMaintenanceDao;
	/**增加setXXXX()方法,spring就可以通过autowire自动设置对象属性,请注意大小写*/
	public void setTbMaintenanceDao(TbMaintenanceDao dao) {
		this.tbMaintenanceDao = dao;
	}
	public EntityDao getEntityDao() {
		return this.tbMaintenanceDao;
	}
	
	@Transactional(readOnly=true)
	public Page findPage(TbMaintenanceQuery query) {
		return tbMaintenanceDao.findPage(query);
	}
